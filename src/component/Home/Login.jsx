...
export default function Login() {
    ...
    return (<section className="py-26 bg-white">
            <div className="container px-4 mx-auto">
                <div className="max-w-lg mx-auto">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button
                            className="inline-block w-full py-2 px-4 mb-6 text-center text-lg leading-6 text-white font-extrabold bg-indigo-800 hover:bg-indigo-900 border-3 border-indigo-900 shadow rounded transition duration-200 submit-login-btn">
                            {" "}
                            Login
                        </button>
