...
export default function SecondHome() {
    ...
    const onChange = (e) => {
        setInputData((prevInputData) => ({
            ...prevInputData, [e.target.name]: e.target.value,
        }));
    };
                        ...
                        <form onSubmit={handleSubmit} className="home__data">
                            <div className='home__actionRow__2zr8E mb-4 flex justify-between'>
                                <div>
                                    ...
                                    <select name="province" onChange={onChange} value={inputData.province}
                                            className="outline-offset-0 outline-transparent">
                            ...
                            <div className="ant-row-flex styles__bookOrderWidget___1orvu">
                                <div className="deli-destination flex items-center justify-between">
                                    <div
                                        className="ant-col styles__poiField___1MV95 styles__pickUp___3yfVZ ant-col-xs-22 ant-col-md-6">
                                        <div className="styles__location___3el4p">
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                        className="w-full justify-center rounded-md border border-transparent bg-sky-400 py-2 px-2 mt-5 text-sm font-medium text-white shadow-sm hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2 register-account-btn">
                                                    <span>Confirm</span>
                                                </button>
                                            </div>
                                        </div>
                                        <div>
                                            <div className="flex mt-3">
                                                <input type="text" className="text-black text-xs"
                                                       placeholder='sender name?' name="senderName" onChange={onChange}
                                                       value={inputData.senderName}/>
                                                <input type="text" className="text-black text-xs"
                                                       placeholder='Phone Number' name="senderPhone" onChange={onChange}
                                                       value={inputData.senderPhone}/>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <span class="styles__swapIcon___2sM6A">
                                <i aria-label="icon: swap" title="" tabindex="-1" class="anticon anticon-swap">
                                    <svg viewBox="64 64 896 896" focusable="false" class="" data-icon="swap" width="1em"
                                    ...
                                    <div
                                        className="ant-col styles__poiField___1MV95 styles__dropOff___2jYMB ant-col-xs-24 ant-col-md-6">
                                        <div className="styles__location___3el4p">
                                            <button
                                                className=""
                                                type="button"
                                        ...
                                        <div>
                                            <div className="flex mt-3">
                                                <input type="text" className="text-black text-xs"
                                                       placeholder='reciever name?' name="recieverName"
                                                       onChange={onChange} value={inputData.recieverName}/>
                                                <input type="text" className="text-black text-xs"
                                                       placeholder='Phone Number' name="recieverPhone"
                                                       onChange={onChange} value={inputData.recieverPhone}/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div>
                                        <div className="flex justify-between items-center mt-3">
                                            <select name="size"
                                                    className="outline-offset-0 outline-transparent  bg-blue-100 p-1 rounded-md"
                                                    onChange={onChange} value={inputData.size}>
                                            ...
                                            <div className=" bg-blue-100 rounded-md p-1">
                                                ...
                                                <input type="number" name="kg" value={inputData.kg}
                                                       onChange={onChange}/>
                                                <label htmlFor="kilo">kg</label>
                                            </div>
                                            <div>
                                                <select name="type" onChange={onChange} value={inputData.type}
                                                        className="outline-offset-0 outline-transparent bg-blue-100 p-1 rounded-md">
                                            ...
                                            <div>
                                                <select name="deliveryBy" value={inputData.deliveryBy}
                                                        onChange={onChange}
                                                        className="outline-offset-0 outline-transparent bg-blue-100 p-1 rounded-md">
                                            ...
                                            <div>
                                                <select name="cashBy" value={inputData.cashBy} onChange={onChange}
                                                        className="outline-offset-0 outline-transparent bg-blue-100 p-1 rounded-md">
                            ...
                            <div>
                                <button type="submit" className="book mt-4 text-sm text-white">{" "} Book Delivery
                                </button>
                            </div>
                        </form>
                    </div>
